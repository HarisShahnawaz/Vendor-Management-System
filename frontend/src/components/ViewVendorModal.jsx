        ...
        <div className="sticky top-0 z-10 flex items-center justify-between border-b border-slate-200 bg-white/95 backdrop-blur-md px-6 py-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500">Vendor Profile Details</p>
            </div>
          </div>
          <button 
            onClick={onClose}
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="rounded-xl border border-slate-200 bg-slate-50 p-5">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <p className="mt-1 text-sm font-semibold text-slate-900">{vendor.companyName}</p>
              </div>
              <div>
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="mt-1 text-sm text-slate-700">{vendor.email}</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="mt-1 text-sm text-slate-700">{vendor.contactNumber}</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="rounded-xl border border-slate-200 bg-slate-50 p-5">
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                <label className="text-xs text-slate-500 font-medium uppercase tracking-wider">Full Address</label>
                <p className="mt-1 text-sm text-slate-700 leading-relaxed">{vendor.address}</p>
              </div>
            </div>
          </div>
          ...
          <div className="rounded-xl border border-slate-200 bg-slate-50 p-5">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label className="text-xs text-slate-500 font-medium uppercase tracking-wider">Profile ID</label>
                <p className="mt-1 text-sm font-mono text-slate-700">{vendor._id}</p>
              </div>
              <div>
                <label className="text-xs text-slate-500 font-medium uppercase tracking-wider">Registration Date</label>
